        ...
        <div class="modal-content" onclick="stopPropagation()" >
            ...
            <form id="reportForm">
                <div class="form-group">
                    <label for="disasterType">Name</label>
                    <input type="text" id="disasterType" required>
                </div>

                <div class="form-group">
                    <label for="location"> Disaster Type </label>
                    <input type="text" id="Team" required>
                </div>

                <div class="form-group">
                    <label for="Assigned Team">Role </label>
                    <input type="text" id="Team" required>
                </div>

                <div class="form-group">
                    <label for="Affected Areas">Location</label>
                    <input type="text" id="Team" required>
                </div>

                <div class="form-group">
                    <label for="Assigned Team">Status </label>
                    <input type="text" id="Team" required>
                </div>

                <div class="form-group">
                    <label for="location">Date_Reported</label>

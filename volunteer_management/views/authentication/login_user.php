...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <img src="users/images/Frame 1 (1).svg" alt="">
            <h1>WELCOME!</h1>
            ...
            <form id="loginForm">
                <div class="form-group">
                    ...
                    <a href="users/community.php" class="login-btn">Login</a>

                    </div>
    
                    <div class="link">
                        <p class="login-link">Don't Have an Account Yet? <a href="create account/step1.php">Create Your Account</a></p>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="right-section">
            <div class="content">
                <img src="users/images/Rectangle 1012.png" alt="">
            </div>

...
<head>
    ...
    <link rel="stylesheet" href="<?php echo '/volunteer_management/assets/css/user/main.css'; ?>">
...
<div id="overlay" id="overlay"></div>
    <div id="sidebar" id="sidebar" onclick="stopPropagation()">
        ...
        <nav id="nav-menu">
            <ul>
                 <ol><a href="../admin/main_dashboard.php">Dashboard</a></ol>
                 <ol> <a href="../views/user/community_report.php">Account</a></ol>
    ...
    <header id="top-header">
        ...
        <nav id="nav-menu">
            <a href="../admin/main_dashboard.php" id="dashboard-link">Dashboard</a>
            <a href="user-report-records.php" id="community-link">Account</a>
    ...
    <div id="sub-header">
        ...
        <div id="right-section">
            <button id="report-btn" class="report-btn" onclick="openModal()">REPORT</button>
            <div id="time-box">
